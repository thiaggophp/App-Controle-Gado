  ...
  useEffect(()=>{(async()=>{
    ...
    if(salvo){
      ...
      try{
        ...
        else if(atualizado&&atualizado.status==="active"){setUsuario(atualizado);localStorage.setItem("gado_usuario",JSON.stringify(atualizado));if(atualizado.mustChangePassword)setSenhaModal(true)}
